...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent intent10 = new Intent(MainActivity.this, DepartmentActivity.class);
            startActivity(intent10);

        } else if (id == R.id.nav_gallery) {

            Intent intent11 = new Intent(MainActivity.this, GalleryActivity.class);
            startActivity(intent11);

        } else if (id == R.id.nav_slideshow) {

            Intent intent12 = new Intent(MainActivity.this, CreditsActivity.class);
            startActivity(intent12);

        } else if (id == R.id.nav_manage) {

            Intent intent13 = new Intent(MainActivity.this, SupportActivity.class);
